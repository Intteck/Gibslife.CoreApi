...
{
    public class CreditNote : NoteBase
    {
        //[Required]
        public string CreditNoteNo { get; protected set; }
        ...
        public CreditNote(ICodeNumberFactory codeFactory, PolicyHistory history/*, DebitNoteTypeEnum debitNoteType*/) : base(history)
        {
            History = history;
            //Premium = history.Premium.ShallowCopy();

            DeclarationNo = history.DeclareNo;
            CreditNoteNo = codeFactory.CreateCodeNumber(CodeTypeEnum.DNOTE, null);
